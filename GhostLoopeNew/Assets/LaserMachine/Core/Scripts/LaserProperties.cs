...
public class LaserProperties
{
	...
	public float m_maxRadialDistance = 1;
    ...
    [Header("Boss PoisonBomb")]
    public float m_laserDamage = 20.0f;
    public float m_laserCooldown = 1;
    public float m_unitLength = 0.5f;
    public float m_targetMaxLength = 15.0f;
    }

...
public class BossGrimReaper : Enemy
{
    ...
    protected void Update()
    {
        ...
        if (grimStatusContainer.Contains(E_GrimStatus.skill1))
        {
            ...
            else
            {
                ...
                {
                    DashToward();
                    MusicManager.GetInstance().PlayFireSound("BOSS3-1≥Â¥Ã“Ù–ß");
                }
                else
                {
                    // animation
    ...
    {
        MusicManager.GetInstance().PlayFireSound("“ªΩ◊∂Œ–˝◊™“∆∂Øµƒ“Ù–ß");
    ...
    private void CheckHP()
    {
        ...
        if (hp <= 0)
        {
            MusicManager.GetInstance().PlayFireSound("±¨’®“Ù–ß");
    ...
    {
        MusicManager.GetInstance().PlayFireSound("∫·œÚª”ø≥¡≠µ∂“Ù–ß");
